...
#include "lcd.h"
#include <stdio.h>						// LCD Header file included that contains function definitions essential to deal with LCD
 ...
 */
void lcd_print_binary(unsigned char row_num, unsigned char col_num, int num)
{
	int bin = 0, temp = 0, n=0, t=1;
	char string[20];
	n = num;
	while (n!=0) 
	{
	...
	sprintf(string, "%08d", bin);
	lcd_string(row_num, col_num, string );
 ...
 * @param[in]  num      The number to be printed
 */
void lcd_print_octal(unsigned char row_num, unsigned char col_num, int num)
{
	char string[20];
	sprintf(string,"%03o", num);
	lcd_string(row_num, col_num, string );
}
 ...
 * @param[in]  num      The number to be printed
 */
void lcd_print_decimal(unsigned char row_num, unsigned char col_num, int num)
{
	char string[20];
	sprintf(string,"%03d", num);
	lcd_string(row_num, col_num, string );
}
 ...
 * @param[in]  num      The number to be printed
 */
void lcd_print_hexadecimal(unsigned char row_num, unsigned char col_num, int num)
{
	char string[20];
